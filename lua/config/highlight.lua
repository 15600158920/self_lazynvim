...
wk.register({
  ["<leader>h"] = {
    ...
    D = {
      ...
      "dismiss all highlight",
    },
  },
})

vim.api.nvim_create_user_command("HlToggle", function()
  highlightToggle()
end, {})
vim.api.nvim_create_user_command("HlEnable", function()
  highlightEnable()
end, {})
vim.api.nvim_create_user_command("HlDismiss", function()
  highlightDismiss()
end, {})
vim.api.nvim_create_user_command("HlDismissAll", function()
  highlightDismissAll()
end, {})
